...
df = pd.read_excel(excel_file, sheet_name='INVOICE', skiprows=15, usecols='A:G', header=None)
print(df)

# 첫 번째 행을 헤더로 설정 및 데이터 전처리
# df.columns = df.iloc[0]  # 첫 번째 로드된 행을 열 이름으로 사용 아 ㅅㅅㅅㅅㅅㅅㅅㅅㅅㅅㅅㅅㅅㅅ발  이것 때문이었어 !!!!!!!!!!!!!!!!!!
